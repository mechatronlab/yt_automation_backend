...
router.put('/:id', protect, upload.single('ovpnFile'), updateAccount);
router.post('/:id/vpn-config', protect, upload.single('ovpnFile'), uploadVpnConfig);
router.put('/:id/active', protect, setActiveAccount);
router.put('/:id/inactive', protect, setInactiveAccount);
router.post('/:id/refresh-channel', protect, refreshYoutubeChannel);
router.get('/:id/channels', protect, getAccountChannels);
router.post('/:id/select-channel', protect, selectAccountChannel);
